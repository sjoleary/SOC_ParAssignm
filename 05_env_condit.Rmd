...
```{r fig.cap="Fig 6b: pRDA biplot indicating environmental variables (arrows) and clustering of individuals by spawning event (shape) and sample point (fill).", fig.height=18, fig.width=6}


ggplot(ind_rda.env, aes(x = RDA1_WA_SCALED3, RDA2_WA_SCALED3,
                        fill = BLOCK, color = BLOCK,
                        shape = SPAWNING_EVENT, group = BLOCK)) +
...
```{r fig.cap="Fig 7a: Distribution of loci flagged as non-associated (grey) vs outlier (red) based on Mahalanobis distance threshold of 13.82 (p < 0.001.", fig.width=7, fig.height=8}
...
```{r fig.cap="Fig 7b: Distribution of Mahalanobis distance per locus across the genome.", fig.width=10, fig.height=4}
...
```{r fig.cap="Fig 7c: Distribution of Mahalanobis distance per locus for scaffolds with 4 flagged outlier loci. Loci above red dashed line are flagged as significantly associated.", fig.width=10, fig.height=4}
...
```{r fig.cap="Fig 7d: Distribution of Mahalanobis distance per locus for scaffolds with three flagged outlier loci. Loci above red dashed line are flagged as significantly associated.", fig.width=10, fig.height=40}
...
```{r fig.cap="Fig 7e: Distribution of Mahalanobis distance per locus for scaffolds with two flagged outlier loci. Loci above red dashed line are flagged as significantly associated.", fig.width=10, fig.height=50}
